...
📜 Licence
Ce projet est open-source, mais je reste propriétaire de tout projet utilisant cette base.
Toute utilisation de ce code comme fondation pour un autre projet doit mentionner l'auteur original et respecter cette condition.
